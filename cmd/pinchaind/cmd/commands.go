...
import (
	...
	"github.com/pinchain/pinchain/app"
)
...
// genesisCommand builds genesis-related `pinchaind genesis` command. Users may provide application specific commands as a parameter
